...
proc create_root_design { parentCell } {
  ...
  set rgb2ycbcr_1 [ create_bd_cell -type ip -vlnv opnendv.com:user:rgb2ycbcr:1.0 rgb2ycbcr_1 ]
  ...
  connect_bd_intf_net -intf_net ov5640_capture_data_0_cmos_rgb [get_bd_intf_pins ov5640_capture_data_0/cmos_rgb] [get_bd_intf_pins rgb2ycbcr_1/pre_image]
  ...
  connect_bd_intf_net -intf_net rgb2lcd_0_lcd1 [get_bd_intf_ports lcd] [get_bd_intf_pins rgb2lcd_0/lcd]
  connect_bd_intf_net -intf_net rgb2lcd_0_lcd_rgb [get_bd_intf_ports lcd_rgb] [get_bd_intf_pins rgb2lcd_0/lcd_rgb]
  connect_bd_intf_net -intf_net rgb2ycbcr_1_pos_image [get_bd_intf_pins rgb2ycbcr_1/pos_image] [get_bd_intf_pins v_vid_in_axi4s_0/vid_io_in]
  ...
  connect_bd_net -net axi_dynclk_0_LOCKED_O [get_bd_pins axi_dynclk_0/LOCKED_O] [get_bd_pins ov5640_capture_data_0/rst_n] [get_bd_pins rgb2lcd_0/vid_rst] [get_bd_pins rgb2ycbcr_1/rst_n]
  ...
  connect_bd_net -net cam_data_1 [get_bd_ports cam_data] [get_bd_pins ov5640_capture_data_0/cam_data]
  connect_bd_net -net cam_href_1 [get_bd_ports cam_href] [get_bd_pins ov5640_capture_data_0/cam_href]
  connect_bd_net -net cam_pclk_1 [get_bd_ports cam_pclk] [get_bd_pins ov5640_capture_data_0/cam_pclk]
  connect_bd_net -net cam_vsync_1 [get_bd_ports cam_vsync] [get_bd_pins ov5640_capture_data_0/cam_vsync]
  ...
  connect_bd_net -net ov5640_capture_data_0_cmos_frame_ce [get_bd_pins ov5640_capture_data_0/cmos_frame_ce] [get_bd_pins rgb2ycbcr_1/rgb_clken]
  connect_bd_net -net ov5640_capture_data_0_cmos_frame_clk [get_bd_pins ov5640_capture_data_0/cmos_frame_clk] [get_bd_pins rgb2ycbcr_1/clk] [get_bd_pins v_vid_in_axi4s_0/vid_io_in_clk]
  ...
  connect_bd_net -net rgb2ycbcr_1_ycbcbr_clken [get_bd_pins rgb2ycbcr_1/ycbcbr_clken] [get_bd_pins v_vid_in_axi4s_0/vid_io_in_ce]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_dynclk_0/s00_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn] [get_bd_pins v_tc_0/s_axi_aresetn]
