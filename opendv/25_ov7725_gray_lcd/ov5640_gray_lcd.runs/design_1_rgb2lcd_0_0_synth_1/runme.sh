...
HD_PWD='E:/PS/ov5640_gray_lcd/ov5640_gray_lcd.runs/design_1_rgb2lcd_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_rgb2lcd_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_rgb2lcd_0_0.tcl
