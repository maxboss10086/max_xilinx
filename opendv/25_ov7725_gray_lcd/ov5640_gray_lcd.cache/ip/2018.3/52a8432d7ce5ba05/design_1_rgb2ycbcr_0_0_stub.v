...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clk, rst_n, pre_frame_vsync, pre_frame_clken, 
  pre_frame_hsync, rgb_data, frame_vsync, frame_hsync, ycbcr_data, pos_frame_clken)
/* synthesis syn_black_box black_box_pad_pin="clk,rst_n,pre_frame_vsync,pre_frame_clken,pre_frame_hsync,rgb_data[23:0],frame_vsync,frame_hsync,ycbcr_data[23:0],pos_frame_clken" */;
  input clk;
  input rst_n;
