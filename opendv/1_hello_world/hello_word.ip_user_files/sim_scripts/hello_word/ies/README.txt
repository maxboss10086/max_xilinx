...
#
# Generated by export_simulation on Thu Apr 23 15:11:40 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './hello_word.sh' script.

./hello_word.sh -reset_run
...
./hello_word.sh -noclean_files

For more information on the script, please type './hello_word.sh -help'.
