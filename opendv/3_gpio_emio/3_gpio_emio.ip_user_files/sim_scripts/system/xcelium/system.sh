...
execute()
{
  xrun $xrun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../3_gpio_emio.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../3_gpio_emio.srcs/sources_1/bd/system/ipshared/70cf/hdl" \
       +incdir+"../../../../3_gpio_emio.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../3_gpio_emio.srcs/sources_1/bd/system/ipshared/70cf/hdl" \
       +incdir+"../../../../3_gpio_emio.srcs/sources_1/bd/system/ip/system_processing_system7_0_0" \
       +incdir+"G:/vivado/Vivado/2018.3/data/xilinx_vip/include"
}
