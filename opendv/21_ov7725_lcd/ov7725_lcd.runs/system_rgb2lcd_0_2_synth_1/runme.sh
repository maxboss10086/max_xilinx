...
HD_PWD='F:/ZYNQ/Embedded_System/ov7725_lcd/ov7725_lcd.runs/system_rgb2lcd_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_rgb2lcd_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_rgb2lcd_0_2.tcl
