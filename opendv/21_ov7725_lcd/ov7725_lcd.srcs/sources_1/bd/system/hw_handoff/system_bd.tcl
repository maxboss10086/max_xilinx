...
proc create_root_design { parentCell } {
  ...
  # Create instance: ov7725_capture_data_0, and set properties
  set ov7725_capture_data_0 [ create_bd_cell -type ip -vlnv alientek.com:user:ov7725_capture_data:1.0 ov7725_capture_data_0 ]
  ...
  connect_bd_intf_net -intf_net ov7725_capture_data_0_cmos_rgb [get_bd_intf_pins ov7725_capture_data_0/cmos_rgb] [get_bd_intf_pins v_vid_in_axi4s_0/vid_io_in]
  ...
  connect_bd_net -net axi_dynclk_0_LOCKED_O [get_bd_pins axi_dynclk_0/LOCKED_O] [get_bd_pins ov7725_capture_data_0/rst_n] [get_bd_pins rgb2lcd_0/vid_rst]
  ...
  connect_bd_net -net cam_data_0_1 [get_bd_ports cam_data] [get_bd_pins ov7725_capture_data_0/cam_data]
  connect_bd_net -net cam_href_0_1 [get_bd_ports cam_href] [get_bd_pins ov7725_capture_data_0/cam_href]
  connect_bd_net -net cam_pclk_0_1 [get_bd_ports cam_pclk] [get_bd_pins ov7725_capture_data_0/cam_pclk]
  connect_bd_net -net cam_vsync_0_1 [get_bd_ports cam_vsync] [get_bd_pins ov7725_capture_data_0/cam_vsync]
  connect_bd_net -net ov7725_capture_data_0_cam_rst_n [get_bd_ports cam_rst_n] [get_bd_pins ov7725_capture_data_0/cam_rst_n]
  connect_bd_net -net ov7725_capture_data_0_cam_sgm_ctrl [get_bd_ports cam_sgm_ctrl] [get_bd_pins ov7725_capture_data_0/cam_sgm_ctrl]
  connect_bd_net -net ov7725_capture_data_0_cmos_frame_ce [get_bd_pins ov7725_capture_data_0/cmos_frame_ce] [get_bd_pins v_vid_in_axi4s_0/vid_io_in_ce]
  connect_bd_net -net ov7725_capture_data_0_cmos_frame_clk [get_bd_pins ov7725_capture_data_0/cmos_frame_clk] [get_bd_pins v_vid_in_axi4s_0/vid_io_in_clk]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_dynclk_0/s00_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins v_tc_0/s_axi_aresetn]
