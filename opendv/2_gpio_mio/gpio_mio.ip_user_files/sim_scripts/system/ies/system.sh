...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../gpio_mio.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../gpio_mio.srcs/sources_1/bd/system/ipshared/70cf/hdl" \
       +incdir+"../../../../gpio_mio.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../gpio_mio.srcs/sources_1/bd/system/ipshared/70cf/hdl" \
       +incdir+"../../../../gpio_mio.srcs/sources_1/bd/system/ip/system_processing_system7_0_0" \
       +incdir+"D:/EDA/Vivado/2018.3/data/xilinx_vip/include"
}
