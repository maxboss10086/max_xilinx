...
//wire define
wire  [7:0]   per_img_Y ;
wire  [7:0]   matrix_p11, matrix_p12, matrix_p13;  //3X3矩阵的输出数据
...
cordic_0  u_SQRT (
  ...
  .m_axis_dout_tdata       ( pixel_sobel_value )   // output wire [15 : 0] m_axis_dout_tdata
);
