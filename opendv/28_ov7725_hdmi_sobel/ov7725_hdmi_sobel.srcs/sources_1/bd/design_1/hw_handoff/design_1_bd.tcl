...
proc create_root_design { parentCell } {
  ...
  set cam_sgm_ctrl [ create_bd_port -dir O cam_sgm_ctrl ]
  ...
  # Create instance: obel_edge_detector_0, and set properties
  set obel_edge_detector_0 [ create_bd_cell -type ip -vlnv opnendv.com:user:obel_edge_detector:1.0 obel_edge_detector_0 ]

  # Create instance: ov7725_capture_data_1, and set properties
  set ov7725_capture_data_1 [ create_bd_cell -type ip -vlnv alientek.com:user:ov7725_capture_data:1.0 ov7725_capture_data_1 ]
  ...
  connect_bd_intf_net -intf_net obel_edge_detector_0_pos_image [get_bd_intf_pins obel_edge_detector_0/pos_image] [get_bd_intf_pins v_vid_in_axi4s_0/vid_io_in]
  connect_bd_intf_net -intf_net ov7725_capture_data_1_cmos_rgb [get_bd_intf_pins obel_edge_detector_0/pre_image] [get_bd_intf_pins ov7725_capture_data_1/cmos_rgb]
  ...
  connect_bd_net -net axi_dynclk_0_LOCKED_O [get_bd_pins DVI_Transmitter_0/reset_n] [get_bd_pins axi_dynclk_0/LOCKED_O] [get_bd_pins obel_edge_detector_0/rst_n] [get_bd_pins ov7725_capture_data_1/rst_n]
  connect_bd_net -net axi_dynclk_0_PXL_CLK_5X_O [get_bd_pins DVI_Transmitter_0/pclk_x5] [get_bd_pins axi_dynclk_0/PXL_CLK_5X_O]
  connect_bd_net -net cam_data_1 [get_bd_ports cam_data] [get_bd_pins ov7725_capture_data_1/cam_data]
  connect_bd_net -net cam_href_1 [get_bd_ports cam_href] [get_bd_pins ov7725_capture_data_1/cam_href]
  connect_bd_net -net cam_pclk_1 [get_bd_ports cam_pclk] [get_bd_pins ov7725_capture_data_1/cam_pclk]
  connect_bd_net -net cam_vsync_1 [get_bd_ports cam_vsync] [get_bd_pins ov7725_capture_data_1/cam_vsync]
  connect_bd_net -net obel_edge_detector_0_post_frame_clken [get_bd_pins obel_edge_detector_0/post_frame_clken] [get_bd_pins v_vid_in_axi4s_0/vid_io_in_ce]
  connect_bd_net -net ov7725_capture_data_1_cam_rst_n [get_bd_ports cam_rst_n] [get_bd_pins ov7725_capture_data_1/cam_rst_n]
  connect_bd_net -net ov7725_capture_data_1_cam_sgm_ctrl [get_bd_ports cam_sgm_ctrl] [get_bd_pins ov7725_capture_data_1/cam_sgm_ctrl]
  connect_bd_net -net ov7725_capture_data_1_cmos_frame_ce [get_bd_pins obel_edge_detector_0/per_frame_clken] [get_bd_pins ov7725_capture_data_1/cmos_frame_ce]
  connect_bd_net -net ov7725_capture_data_1_cmos_frame_clk [get_bd_pins obel_edge_detector_0/clk] [get_bd_pins ov7725_capture_data_1/cmos_frame_clk] [get_bd_pins v_vid_in_axi4s_0/vid_io_in_clk]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins DVI_Transmitter_0/pclk] [get_bd_pins axi_dynclk_0/PXL_CLK_O] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_clk] [get_bd_pins v_tc_0/clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_dynclk_0/s00_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins v_axi4s_vid_out_0/aresetn] [get_bd_pins v_tc_0/resetn]
