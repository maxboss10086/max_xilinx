...
HD_PWD='E:/Bilibili_FPGA/N4_Project/VIVADO/hdl_netlist/fir_filter.runs/fir_filter_blk_mem_gen_i0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fir_filter_blk_mem_gen_i0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fir_filter_blk_mem_gen_i0.tcl
