...
HD_PWD='E:/Bilibili_FPGA/N3_Project/VIVADO/hdl_netlist/trapezoid_filter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log trapezoid_filter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source trapezoid_filter.tcl -notrace
