...
HD_PWD='E:/Bilibili_FPGA/N3_Project/VIVADO/hdl_netlist/trapezoid_filter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log trapezoid_filter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source trapezoid_filter.tcl
