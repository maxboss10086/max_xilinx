...
HD_PWD='E:/Bilibili_FPGA/N3_Project/VIVADO/hdl_netlist/trapezoid_filter.runs/trapezoid_filter_blk_mem_gen_i0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log trapezoid_filter_blk_mem_gen_i0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source trapezoid_filter_blk_mem_gen_i0.tcl
