...
HD_PWD='E:/Bilibili_FPGA/N2_Project/VIVADO/demo_v1/hdl_netlist/demo_sg.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log demo_sg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source demo_sg.tcl -notrace
