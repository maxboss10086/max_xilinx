...
HD_PWD='E:/Bilibili_FPGA/N2_Project/VIVADO/demo_v1/hdl_netlist/demo_sg.runs/demo_sg_blk_mem_gen_i0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log demo_sg_blk_mem_gen_i0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source demo_sg_blk_mem_gen_i0.tcl
