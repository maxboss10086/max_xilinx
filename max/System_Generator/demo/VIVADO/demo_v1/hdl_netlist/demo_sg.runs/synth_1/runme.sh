...
HD_PWD='E:/Bilibili_FPGA/N2_Project/VIVADO/demo_v1/hdl_netlist/demo_sg.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log demo_sg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source demo_sg.tcl
